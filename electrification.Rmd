...
bind_rows(L84_2017a, L84_2017b) -> L84_2017
union(L84_2017a, L84_2017b) -> L84_2017



 %>% unique() %>%  filter(Self.Reported.Gross.Floor.Area..ft². >= 50000, Self.Reported.Gross.Floor.Area..ft². < 9000000) %>% filter(Largest.Property.Use.Type != "0")
