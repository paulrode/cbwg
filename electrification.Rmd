...
You can also do this using sapply from base R to replace @Ronak’s for loop. invisible is not a necessary function but just wrapped around sapply to make it work silently.
invisible(
