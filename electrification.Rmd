...
# Deal with sites that have multiple BBLs 
data.frame(str_length(L84_2020$BBL)) %>% 
str(str_length(L84_2020$BBL))
summary(str_length(L84_2020$BBL))

data.frame(str_length(L84_2020$BBL)) %>% 
ggplot(aes(str_length.L84_2020.BBL.)) +
  geom_histogram()
