...
L84_2017_A <- L84_2017
outliers_steam <- boxplot(L84_2017$District.Steam.Use..kBtu., plot = FALSE)$out
outliers_elect <- boxplot(L84_2017$Electricity.Use...Grid.Purchase..kBtu., plot = FALSE)$out
outliers_gas <- boxplot(L84_2017$Natural.Gas.Use..kBtu., plot = FALSE)$out
outliers_sf <- boxplot(L84_2017$`Self.Reported.Gross.Floor.Area..ft².` , plot = FALSE)$out
L84_2017_A %>% filter(District.Steam.Use..kBtu. %!in% outliers_steam ) -> L84_2017_A
L84_2017_A %>% filter(Natural.Gas.Use..kBtu. %!in% outliers_gas ) -> L84_2017_A
