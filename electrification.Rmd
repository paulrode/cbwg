...
# look this up https://statisticsglobe.com/dplyr-message-summarise-has-grouped-output-r
...
# Look at sf of submission by type by year with EUI
L84_2019 %>% 
  ...
  mutate(across(where(is.numeric), ~ round(., digits = 3))) %>%
    ...
    select(Type, EnergyS, EnergyP, GSF, EUI) %>% 
  kable(format = "html", digits = 9, col.names = c("Use Type", "T.Energy", "%  of Energy", "GSF", "EUI")) %>%     
  kable_styling(full_width = FALSE)


###### Trying a new way to summarize ######
# display summary by grouping subjects with age
# tapply(L84_2019$Type , L84_2019$EUI, summary) 
###### Trying a new way to summarize ######
