...
AllData %>% 
  ...
  kable(digits = 3, 
        ...
        align = "lcccccc", 
        caption = "<center><strong><strong>GSF of Use Types by Submission Year</strong></strong></center>",
        label = "Table 1", 
...
AllData %>% 
  ...
  kable(digits = 3, 
        col.names = c("Building Use Type", "2015", "2016", "2017", "2018", "2019", "2020"),
        align = "lcccccc", 
        caption = "<center><strong><strong>Number of Use Types by Submission Year</strong></strong></center>",
        label = "Table 1", 
        format.args = list(decimal.mark = ".", big.mark = ","),
        escape = FALSE) %>% 
  kable_styling()
