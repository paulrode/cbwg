...
L84 %>%
  mutate(Oil = Oil1 + Oil2 + Oil4 + Oil56) -> L84
  select(-Oil1, -Oil2, -Oil4, -Oil56) -> L84


L84_2017 %>%
  mutate( "Oil..kBtu" = Fuel.Oil..2.Use..kBtu. + Fuel.Oil..4.Use..kBtu. + Fuel.Oil..5...6.Use..kBtu.) -> L84_2017
