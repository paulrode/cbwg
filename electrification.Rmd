...
L84_2015[c(8:20)] <- apply(L84_2015[c(8:20)], 2, as.numeric )
...
L84_2015 %>%
  mutate(Type2 = fct_lump_n(Type, n=6, w = GSF)) 
...
L84_2020 %>% 
  ...
  mutate(across(where(is.numeric), ~ round(., digits = 3))) %>%
    arrange(desc(GSF))  %>% 
  kable(format = "html", digits = 6, col.names = c("Use Type", "T.Energy", "GSF")) %>%     
