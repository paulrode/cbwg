...
# 6 Look at sf of submission by type by year with EUI
L84_2019 %>% 
  ...
  kable(format = "html", digits = 9, col.names = c("Use Type", "T.Energy", "%  of Energy", "GSF", "EUI")) %>%     kable_styling(full_width = FALSE)
