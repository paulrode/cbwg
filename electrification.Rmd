...
my_packages <- c("tidyverse", "lubridate", "fable", "tsibbledata", "ggplot2", "forecast", "tseries", "rio", "zoo", "readxl", "tsibbledata", "knitr", "kablExtra", "formattable") 
...
=======
 place <- "Home"
#place <-  "work"
>>>>>>> 438cee1150b92d4a96ab9d9d0651fc1b58adc523
...
L84_2016 <- read_excel("data/2016_nyc_benchmarking.xlsx", sheet = "Information and Metrics", col_names = TRUE, na = "NA"  ) %>%  rbind( read_excel("data/2016_nyc_benchmarking.xlsx", sheet = "Multi-BBL", col_names = TRUE, na = "NA"  )) %>%   
  mutate(Data = "2016") %>%
  data.frame() 
L84_2016$`Largest.Property.Use.Type...Gross.Floor.Area..ft².` <- as.numeric(L84_2016$`Largest.Property.Use.Type...Gross.Floor.Area..ft².`)
L84_2016$Year.Built <- as.numeric(L84_2016$Year.Built)
...
L84_2016$bins <- cut(L84_2016$`Largest.Property.Use.Type...Gross.Floor.Area..ft².`, breaks = c(0,50000, 100000, 500000, 1000000, 9000000), dig.lab = 7 , ordered_result = TRUE, labels = Building_GSF_Ranges ) 
L84_2016$Year.Range <- cut(L84_2016$Year.Built, breaks = c(0, 1942, 1980, 2021),dig.lab = 4, labels = Building_Ages)
