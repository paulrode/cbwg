...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
T17 <- filter(L84, Data == "2017") %>% select(BBL, Address)
T16 <- filter(L84, Data == "2016") %>% select(BBL, Address)
T15 <- filter(L84, Data == "2015") %>% select(BBL, Address)

T_Office <- inner_join(T17, T16, by = "BBL") %>% filter(BBL != "0")
length(unique(T_Office$BBL))
length(unique(L84_2017$Address))
length(unique(L84_2017$BBL))
