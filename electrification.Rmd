...
L84_2017[take.out:(nrow(L84_2017)-take.out),] 
L84_2017 %>% arrange(`NGas (kBtu)`) -> L84_2017
L84_2017[take.out:(nrow(L84_2017)-take.out),]
L84_2017 %>% arrange(`Electric (kBtu)`) -> L84_2017
L84_2017[take.out:(nrow(L84_2017)-take.out),]
remove(take.out)


L84_2017.sum.catagory <- L84_2017 %>% group_by(Catagory) %>% summarise(GSF = sum(GSF), NGas = sum(`NGas (kBtu)`), Elect = sum(`Electric (kBtu)`))
