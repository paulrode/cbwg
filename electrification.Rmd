...
Types %>% 
    select(Type, Number, GSF, T.Energy_MMbtu, tCO2e_2024) %>% 
    mutate(across(where(is.numeric), signif, 3)) %>%  
    kable(format = "html", digits = 6, col.names = c("Use Type", "Quantity", "GSF", "Total Energy (MMBTU)", "tCO2e")) %>%     kable_styling(full_width = FALSE)
