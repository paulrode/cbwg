...
L84_2016 %>% 
  select(`Property Id`, 
         ...
         `Electricity Use - Grid Purchase (kBtu)`,
         `Water Use (All Water Sources) (kgal)`,
         Data ) %>% mutate("Self.Reported.Gross.Floor.Area..ft²." == 
                    as.numeric(`Largest Property Use Type - Gross Floor Area (ft²)`) + as.numeric(`2nd Largest Property Use - Gross Floor Area (ft²)`) + as.numeric(`3rd Largest Property Use Type - Gross Floor Area (ft²)`) ) -> L84_b
