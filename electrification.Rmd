...
L84_2017 %>% filter(`Site.EUI..kBtu.ft².` < 500) %>%
  filter(Primary.Property.Type...Self.Selected == "Office" | Primary.Property.Type...Self.Selected == "Multifamily Housing") %>%
  ggplot(aes( x = bins, y = EUI, color = Primary.Property.Type...Self.Selected)) +
  geom_boxplot()
