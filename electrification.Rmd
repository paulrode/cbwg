...
"Housing"=c("Multifamily Housing", "Senior Living Community", "Résidence pour personnes âgées", "Residence Hall/Dormitory","Autre"),
...
Types %>% 
    ...
    kable(format = "html", digits = 5, col.names = c("Use Type", "Quantity", "GSF", "Total Energy (kBTU)" )) %>%     kable_styling(full_width = FALSE)
